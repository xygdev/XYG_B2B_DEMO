  		...
  		for(a=0;a<menunum1;a++){ 
  		    ...
  		    if(menujson[a].menu.func[0].name!=null){
  		    	...
  		    	for(b=0;b<funcnum1;b++){
  		    		$('.'+menujson[a].menu.code+' ul:first').append("<li><a href=\"#\" data-href=\""+menujson[a].menu.func[b].href+"\" data-level=\"1\"><i class=\""+menujson[a].menu.func[b].icon+"\"></i>"+menujson[a].menu.func[b].name+"</a></li>");
  		    	}
  		    }
  		        ...
  		        for(c=0;c<menunum2;c++){ 
  		            ...
  		            if(menujson[a].menu.menu[c].func[0].name!=null){
  		            	...
  		            	for(d=0;d<funcnum2;d++){
  		       			 	$('.'+menujson[a].menu.menu[c].code+' ul:first').append("<li><a href=\"#\" data-href=\""+menujson[a].menu.menu[c].func[d].href+"\" data-level=\"2\"><i class=\""+menujson[a].menu.menu[c].func[d].icon+"\"></i>"+menujson[a].menu.menu[c].func[d].name+"</a></li>");
  		            	}
  		            }
  		    		    ...
  		    		    for(e=0;e<menunum3;e++){ 
  		    				...
  		    				if(menujson[a].menu.menu[c].menu[e].func[0].name!=null){
  		    					...
  		    					for(f=0;f<funcnum3;f++){
  		       			 			$('.'+menujson[a].menu.menu[c].menu[e].code+' ul:first').append("<li><a href=\"#\" data-href=\""+menujson[a].menu.menu[c].menu[e].func[f].href+"\" data-level=\"3\"><i class=\""+menujson[a].menu.menu[c].menu[e].func[f].icon+"\"></i>"+menujson[a].menu.menu[c].menu[e].func[f].name+"</a></li>");
  		    					}
  		    				}
  		    				if(menujson[a].menu.menu[c].menu[e].menu[0].name!=null){
  		    		    		...
  		    		    		for(g=0;g<menunum4;g++){
  		    		    			...
  		    		    			for(h=0;h<funcnum4;h++){
  		       			 				$('.'+menujson[a].menu.menu[c].menu[e].menu[g].code+' ul:first').append("<li><a href=\"#\" data-href=\""+menujson[a].menu.menu[c].menu[e].menu[g].func[h].href+"\" data-level=\"4\"><i class=\""+menujson[a].menu.menu[c].menu[e].menu[g].func[h].icon+"\"></i>"+menujson[a].menu.menu[c].menu[e].menu[g].func[h].name+"</a></li>");
  		    						}
  		    		    		} 		    				
  		    				}
  		    			}
