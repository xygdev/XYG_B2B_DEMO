          ...
          <div class="col-md-12">
            ...
            <div class="features-wrapper">
              <div class="col-md-4 wp2">
                <div class="icon">
                  <img src="img/home_page/CB.jpg" style="width:100%">
                </div>
                <h2>白波</h2>
              ...
              <div class="col-md-4 wp2 delay-05s">
                <div class="icon">
                  <img src="img/home_page/Green.jpg" style="width:100%">
                </div>
                <h2>F绿玻</h2>
              ...
              <div class="col-md-4 wp2 delay-1s">
                <div class="icon">
                  <img src="img/home_page/Gray.jpg" style="width:100%">
                </div>
                <h2>欧洲灰玻</h2>
              ...
              <ul class="slides">
                <li>
                  <div class="col-md-4 wp4">
                    <div class="overlay-effect effects clearfix">
                      <div class="img">
                        <img src="img/home_page/DG.jpg" alt="Portfolio Item">
                        <div class="overlay">
                  ...
                  <div class="col-md-4 wp4 delay-05s">
                    <div class="overlay-effect effects clearfix">
                      <div class="img">
                        <img src="img/home_page/WH.jpg" alt="Portfolio Item">
                        <div class="overlay">
                          <a href="#" class="expand"><i class="fa fa-search"></i><br>View More</a>
                          <a class="close-overlay hidden">x</a>
                        </div>
                  ...
                  <div class="col-md-4 wp4 delay-1s">
                    <div class="overlay-effect effects clearfix">
                      <div class="img">
                        <img src="img/home_page/TJ.jpg" alt="Portfolio Item">
                        <div class="overlay">
                          <a href="#" class="expand"><i class="fa fa-search"></i><br>View More</a>
                          <a class="close-overlay hidden">x</a>
                        </div>
                ...
                <li>
                  <div class="col-md-4 wp4">
                    <div class="overlay-effect effects clearfix">
                      <div class="img">
                        <img src="img/home_page/YK.jpg" alt="Portfolio Item">
                        <div class="overlay">
                          <a href="#" class="expand"><i class="fa fa-search"></i><br>View More</a>
                          <a class="close-overlay hidden">x</a>
                        </div>
                  ...
                  <div class="col-md-4 wp4 delay-05s">
                    <div class="overlay-effect effects clearfix">
                      <div class="img">
                        <img src="img/home_page/DY.jpg" alt="Portfolio Item">
                        <div class="overlay">
                          <a href="#" class="expand"><i class="fa fa-search"></i><br>View More</a>
                          <a class="close-overlay hidden">x</a>
                        </div>
                  ...
                  <div class="col-md-4 wp4 delay-1s">
                    <div class="overlay-effect effects clearfix">
                      <div class="img">
                        <img src="img/home_page/JM.jpg" alt="Portfolio Item">
                        <div class="overlay">
                          <a href="#" class="expand"><i class="fa fa-search"></i><br>View More</a>
                          <a class="close-overlay hidden">x</a>
                        </div>
                ...
                <ul class="slides">
                  <li>
                    <div class="col-md-4 wp5">
                      <img src="img/home_page/batman.jpg" alt="Team Member">
                      <h2>杨镇城</h2>
                      <p>信义超薄玻璃（东莞）有限公司</p>
                    ...
                    <div class="col-md-4 wp5 delay-05s">
                      <img src="img/home_page/ironman.jpg" alt="Team Member">
                      <h2>周冬平</h2>
                      <p>信义节能玻璃（芜湖）有限公司</p>
                    ...
                    <div class="col-md-4 wp5 delay-1s">
                      <img src="img/home_page/american.jpg" alt="Team Member">
                      <h2>邵玉辉</h2>
                      <p>信义玻璃（天津）有限公司</p>
                      <p>电话:022-82971201</p>
				      <p>传真:022-82159967</p>
                  ...
                  <li>
                    <div class="col-md-4 wp5">
                      <img src="img/home_page/hock.jpg" alt="Team Member">
                      <h2>陈泽明</h2>
                      <p>信义玻璃（营口）有限公司</p>
                      <p>电话:0417-8205178</p>
				      <p>传真:0417-8203355</p>
                    ...
                    <div class="col-md-4 wp5 delay-05s">
                      <img src="img/home_page/thunder.jpg" alt="Team Member">
                      <h2>李成</h2>
                      <p>信义节能玻璃（四川）有限公司</p>
                      <p>电话:18227187260</p>
				      <p>传真:022-82159967</p>
                    ...
                    <div class="col-md-4 wp5 delay-1s">
                      <img src="img/home_page/deadpool.jpg" alt="Team Member">
                      <h2>郑长乙</h2>
